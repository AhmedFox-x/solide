          ...
          <div className="grid lg:grid-cols-5 gap-6 mb-16">
            ...
            <div className="lg:col-span-2 flex flex-col gap-4">
              ...
              <motion.div
                ...
                className="mt-auto"
              >
                <button onClick={() => navigate('/', { state: { orderProject: { id: project.id, title: project.title, images: allImages, type: project.type, category: project.category, description: project.description } } })}
